...
public class Email
{
	...
	private String myEmailAccount = "huangjl17@mails.tsinghua.edu.cn";
	private String myEmailPassword = "bf3725c42d4b43e8";

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易126邮箱的 SMTP 服务器地址为: smtp.126.com
	private String myEmailSMTPHost = "smtp.tsinghua.edu.cn";

	// 收件人邮箱（替换为自己知道的有效邮箱）
	private String receiveMailAccount = "huangjl17@mails.tsinghua.edu.cn";
}
